...
namespace Hazel {
    ...
    static const uint32_t s_MeshImportFlags =
        ...
        aiProcess_GenNormals |            // Make sure we have legin normals
        ...
        for (size_t m = 0; m < scene->mNumMeshes; m++)
        {
            ...
            if (scene->HasMaterials())
            {
                ...
                for (uint32_t i = 0; i < scene->mNumMaterials; i++)
                {
                    ...
                    {
                        // TODO: Temp - this should be handled bu Hazel's filesystem
                        ...
                        {
                            HZ_CORE_TRACE("Could not load texture: {0}", texturePath);
