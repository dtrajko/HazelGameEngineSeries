...
namespace Hazel
{
		...
		float tilingFactor, const glm::vec4& tintColor)
	{
		...
		constexpr glm::vec2 textureCoords[] = {
			{ ((x + 0) * spriteWidth) / sheetWidth,  ((y + 0) * spriteHeight) / sheetHeight }, // { 0.0f, 0.0f }
			{ ((x + 1) * spriteWidth) / sheetWidth,  ((y + 0) * spriteHeight) / sheetHeight }, // { 1.0f, 0.0f }
			{ ((x + 1) * spriteWidth) / sheetWidth,  ((y + 1) * spriteHeight) / sheetHeight }, // { 1.0f, 1.0f }
			{ ((x + 0) * spriteWidth) / sheetWidth,  ((y + 1) * spriteHeight) / sheetHeight }, // { 0.0f, 1.0f }
		};
